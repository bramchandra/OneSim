 ...
 */
public abstract class MessageRouterV2 {
    ...
    public static final int Q_MODE_MOFO = 3;
    public static final int Q_MODE_MOPR = 4;
    public static final int Q_MODE_SHLI = 5;
    public static final int Q_MODE_LEPR = 6;
     ...
     */
    public MessageRouterV2(Settings s) {
     ...
     */
    protected MessageRouterV2(MessageRouterV2 r) {
                ...
                Collections.sort(list,
                    ...
                    public int compare(Object o1, Object o2) {
                        ...
                        if (o1 instanceof Tuple) { //ol mengandung tuple ngga?
                            m1 = ((Tuple<Message, Connection>) o1).getKey(); //cari id messagenya? iya gitu po?
                            m2 = ((Tuple<Message, Connection>) o2).getKey();
                        } else if (o1 instanceof Message) {
                            m1 = (Message) o1;
                            m2 = (Message) o2;
            ...
            case Q_MODE_MOPR:
                Collections.sort(list,
                    ...
                    public int compare(Tuple<Message, Connection> tuple1,
                        ...
                        int FPinteger = Double.hashCode(FP);
                        return FPinteger;
                    }
    ...
    protected int compareByQueueMode(Message m1, Message m2) {
        switch (sendQueueMode) {
            ...
            case Q_MODE_SHLI:
                double diff_shli = m1.getTtl() - m2.getTtl();
                if (diff_shli == 0) {
                    return 0;
                }
                return (diff_shli < 0 ? -1 : 1);
            default:
                throw new SimError("Unknown queue mode " + sendQueueMode);
        }
    }
     ...
     */
    public abstract MessageRouterV2 replicate();
