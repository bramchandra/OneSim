 ...
 *
 */
public class DistributedBubbleRapOri
        implements RoutingDecisionEngine, CommunityDetectionEngine, GlobalCentralityEngine {
     ...
     */
    public DistributedBubbleRapOri(Settings s) {
     ...
     * object
     */
    public DistributedBubbleRapOri(DistributedBubbleRapOri proto) {
    ...
    public void doExchangeForNewConnection(Connection con, DTNHost peer) {
        ...
        DistributedBubbleRapOri de = this.getOtherDecisionEngine(peer);
    ...
    public boolean shouldSendMessageToHost(Message m, DTNHost otherHost) {
        ...
        DistributedBubbleRapOri de = getOtherDecisionEngine(otherHost);
    ...
    public boolean shouldDeleteSentMessage(Message m, DTNHost otherHost) {
        ...
        DistributedBubbleRapOri de = this.getOtherDecisionEngine(otherHost);
        return de.commumesWithHost(m.getTo())
                && !this.commumesWithHost(m.getTo());
    }

    public boolean shouldDeleteOldMessage(Message m, DTNHost hostReportingOld) {
        DistributedBubbleRapOri de = this.getOtherDecisionEngine(hostReportingOld);
        return de.commumesWithHost(m.getTo())
                && !this.commumesWithHost(m.getTo());
    }

    public RoutingDecisionEngine replicate() {
        return new DistributedBubbleRapOri(this);
    }
    ...
    private DistributedBubbleRapOri getOtherDecisionEngine(DTNHost h) {
        MessageRouter otherRouter = h.getRouter();
        assert otherRouter instanceof DecisionEngineRouter : "This router only works "
                + " with other routers of same type";

        return (DistributedBubbleRapOri) ((DecisionEngineRouter) otherRouter).getDecisionEngine();
    }
